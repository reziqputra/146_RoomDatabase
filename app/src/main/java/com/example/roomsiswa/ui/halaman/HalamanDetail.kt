    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(imageVector = Icons.Default.Edit, contentDescription = stringResource(id = R.string.edit_siswa))
            }
        },
        modifier = modifier
    ) {innerPadding ->
        ItemDetailsBody(
            ...
            onDelete = {
                ...
                // and the item may not be deleted in the Database. This is because when config
...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID = R.string.nama1, itemDetail = siswa.nama, modifier = Modifier.padding(
            ...
            ItemDetailsRow(
                labelResID = R.string.alamat1, itemDetail = siswa.alamat, modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen.padding_medium
                    )
                )
            ...
            ItemDetailsRow(
                labelResID = R.string.telpon1, itemDetail = siswa.telpon, modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen.padding_medium
                    )
                )
