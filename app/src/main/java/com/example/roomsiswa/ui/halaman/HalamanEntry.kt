...
fun FormInputSiswa(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text(stringResource(R.string.telpon))
            },
            modifier = Modifier.fillMaxWidth(),
            enabled = enabled,
            singleLine = true
        ...
        if (enabled) {
            Text(
                text = stringResource(R.string.required_field), modifier = Modifier.padding(
        ...
        Divider(
            thickness = dimensionResource(R.dimen.padding_small), modifier = Modifier.padding(
